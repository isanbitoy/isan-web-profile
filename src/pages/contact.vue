			...
			<div class="contact__section">
				<div class="form__wrapper">
					<transition name="slide_left" appear>
						<div class="info-box">
							...
							<div class="info-box__detail">
								...
								<div>
									<span>PHONE</span>
									<span>(+63)995-108-5425</span>
								</div>
							</div>
							<p>Check me and follow me @</p>
							<ul>
								<li v-for="icon in icons" :data-tooltip="icon.mediaToolTip">
					...
					<transition name="slide_right" appear>
						<form class="form-box" action="https://formspree.io/isanbitoy@gmail.com" method="POST">
							<fieldset>
							...
							<fieldset>
							    <button name="form_submit" type="submit" id="contact-submit" 
							      	value="Message Sent" data-submit="...Sending">
							      	Submit
							    </button>
							</fieldset>
						</form>
...
export default {
	...
	mounted() {
		EventBus.$emit('restrictHeaderAndFooter', this.setRestriction)
		EventBus.$emit('restrictContactMenu', this.setContactVisibility)
	}
};
</script>